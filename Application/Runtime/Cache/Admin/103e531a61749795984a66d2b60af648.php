...
<head>
    ...
    <link href="/Public/admin/static//Public/admin/static/css/font-awesome.css?v=4.4.0" rel="stylesheet">

    <link href="/Public/admin/static//animate.css" rel="stylesheet">
                ...
                <div class="ibox">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a href="projects.html" class="btn btn-primary btn-xs">添加新音频</a>
                        </div>
                    </div>

...
<head>
    ...
    <link rel="shortcut icon" href="favicon.ico"> <link href="/tp_3.2_audio/Public/admin/static/css/bootstrap.min.css?v=3.3.6" rel="stylesheet">
    ...
    <div class="middle-box text-center loginscreen  animated fadeInDown">
        <div>
            ...
            <form class="m-t" role="form" action="<?php echo U('login/login');?>" method="post">
                ...
                <p class="text-muted text-center"> <a href="login.html#"><small>忘记密码了？</small></a> | <a href=<?php echo U('register/index');?>>注册一个新账号</a>
                </p>

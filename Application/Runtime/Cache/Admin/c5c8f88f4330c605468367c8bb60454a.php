    ...
    <div class="col-sm-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                ...
                <form method="post" class="form-horizontal" action="<?php echo U('user/edit');?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <span class="help-block m-b-none" style="color: red">如果不需要修改密码可不用填写</span>
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group">
                                ...
                                <div class="ibox-content">
                                    <div class="page-container">
                                        ...
                                        <div id="uploader" class="wu-example">
                                            ...
                                            <input type="text" name="file_pic" value="" hidden value="<?php echo ($data["name"]); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-6 b-r">
                        ...
                        <form role="form">
                            <div class="form-group">
                                <label>用户名：</label>
                                <input type="email" placeholder="请输入用户名" class="form-control" value="">
                            </div>
                            <div class="form-group">
                                <label>密码：</label>

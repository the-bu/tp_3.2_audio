...
<body class="gray-bg">
    <div class="row  border-bottom white-bg dashboard-header">
        <div class="col-sm-12">
            <blockquote class="text-warning" style="font-size:14px">欢迎来到本色音乐管理后台

                <br>…………
                <h4 class="text-danger">welcome........</h4>
            </blockquote>
        ...
        <div class="col-sm-3">
            ...
            <br>
            <br>
            <img src="/Public/admin/static/img/qr_code.png" width="100%" style="max-width:264px;">
            <br>
        </div>
        <div class="col-sm-5">
            <h2>
            ...
            <div class="col-sm-4">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <p id="pay-qrcode">
                            <a href="javascript:;"><img src="/Public/admin/static/img/pay.png" width="100%" alt="请使用手机支付宝或者微信扫码支付">
                            </a>
                        </p>
    ...
    <!-- 自定义js -->
    <script src="/Public/admin/static/js/content.js"></script>

    <!-- 欢迎信息 -->
    <script src="/Public/admin/static/js/welcome.js"></script>
</body>
